...
public static class RoleConstants {
    ...
    public static Guid GetRoleIdByCode(string code) {
        return code switch {
            _ when code == Administrator.Code => Administrator.Id,
            _ when code == Manager.Code => Manager.Id,
            _ when code == User.Code => User.Id,
    ...
    public static string GetRoleNameByCode(string code) {
        return code switch {
            _ when code == Administrator.Code => Administrator.Name,
            _ when code == Manager.Code => Manager.Name,
            _ when code == User.Code => User.Name,
            _ => code
        };
    }
}
