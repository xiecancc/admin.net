...
public class MenuPermission : Permission, IAggregateTree<MenuPermission> {
    /// <summary>
    /// 构造函数
    ...
    /// 父菜单权限
    /// </summary>
    /// <value>父菜单权限对象，可以为空</value>
    [Navigate(NavigateType.OneToOne, nameof(ParentId))]
    public new MenuPermission? Parent {
        get; set;
    }
    ...
    /// 子菜单权限列表
    /// </summary>
    /// <value>当前菜单权限的子菜单列表</value>
    [Navigate(NavigateType.OneToMany, nameof(ParentId))]
    public new List<MenuPermission> Children { get; set; } = [];
