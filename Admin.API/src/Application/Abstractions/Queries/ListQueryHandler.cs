...
public abstract class ListQueryHandler<TDomain, TRepository, TQuery, TQueryDto, TListDto>(
    ...
    ILogger<ListQueryHandler<TDomain, TRepository, TQuery, TQueryDto, TListDto>> logger) : QueryHandler<TDomain, TRepository, TQuery, TQueryDto, List<TListDto>>(unitOfWork, repository, mapper, cacheProvider)
