...
public class MenuPermissionListQueryHandler(
    IUnitOfWork unitOfWork,
    IMapper mapper,
    ICacheProvider cacheProvider) : DomainListQueryHandler<MenuPermissionListQuery, MenuPermission, IPermissionRepository<MenuPermission>, MenuPermissionListDto, MenuPermissionQueryParameters>(unitOfWork, mapper, cacheProvider) {
    /// <summary>
    /// 缓存键前缀
    /// </summary>
    protected override string CacheKeyPrefix => CacheKeyConstants.Permission.Prefix;
...
public class MenuPermissionPagedQueryHandler(
    IUnitOfWork unitOfWork,
    IMapper mapper,
    ICacheProvider cacheProvider) : DomainPagedQueryHandler<MenuPermissionPagedQuery, MenuPermission, IPermissionRepository<MenuPermission>, MenuPermissionPagedDto, MenuPermissionQueryParameters>(unitOfWork, mapper, cacheProvider) {
    /// <summary>
    /// 缓存键前缀
    /// </summary>
    protected override string CacheKeyPrefix => CacheKeyConstants.Permission.Prefix;
