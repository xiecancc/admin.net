...
/// <summary>
/// 按钮权限查询参数
/// <para>用于按钮权限列表查询的参数</para>
/// </summary>
public class ButtonPermissionQueryParameters : AggregateQueryParameters<Domain.Entities.ButtonPermission> {
    /// <summary>
    /// 权限编码
    /// </summary>
    ...
    /// 查询条件列表
    /// </summary>
    public override List<System.Linq.Expressions.Expression<System.Func<Domain.Entities.ButtonPermission, bool>>> Predicates() {
        ...
        if (!string.IsNullOrWhiteSpace(ActionType)) {
            predicates.Add(p => p.ActionType.Contains(ActionType!));
        }
