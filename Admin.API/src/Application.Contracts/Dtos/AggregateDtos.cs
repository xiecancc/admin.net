...
/// <summary>
/// 聚合根审计 DTO 基类
/// <para>包含聚合根的审计字段，供 List/Detail/Paged DTO 继承</para>
/// </summary>
public abstract class AggregateAuditDto {
    /// <summary>
    /// 主键 ID
    /// </summary>
...
/// </summary>
public abstract class AggregateListDto : AggregateAuditDto;

/// <summary>
/// 聚合根详情 DTO
/// <para>用于详细信息展示的数据传输对象</para>
/// </summary>
public abstract class AggregateDetailDto : AggregateAuditDto;

/// <summary>
/// 聚合根分页 DTO
/// <para>用于分页响应中的数据传输对象</para>
/// </summary>
public abstract class AggregatePagedDto : AggregateAuditDto;
