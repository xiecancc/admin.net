 ...
 * 功能描述：用户角色关联相关 DTO 验证器，包含用户角色关联创建、操作、查询参数等验证规则
...
/// 用户角色关联查询参数验证器
/// </summary>
public class UserRoleQueryParametersValidator : DtoValidatorBase<UserRoleQueryParameters> {
    /// <summary>
    /// 初始化用户角色关联查询参数验证器
    /// </summary>
    public UserRoleQueryParametersValidator() {
    }
}
