    ...
    <el-header class="frontend-header">
      <div class="header-content">
        ...
        <nav class="header-nav">
          <el-menu :default-active="activeMenu" mode="horizontal" class="header-menu" router>
    ...
    <el-footer class="frontend-footer">
      <div class="footer-content">
        ...
        <div class="footer-links">
          <a href="#" @click.prevent="navigateTo('/privacy')">隐私政策</a>
          <a href="#" @click.prevent="navigateTo('/terms')">服务条款</a>
...
import { Shop, ArrowDown, User, Setting, SwitchButton } from "@element-plus/icons-vue";
