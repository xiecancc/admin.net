    ...
    <el-card shadow="hover" class="settings-card">
      ...
      <el-form :model="settingsForm" :rules="settingsRules" ref="settingsFormRef" label-width="120px">
        ...
        <el-form-item label="网站描述" prop="siteDescription">
          <el-input v-model="settingsForm.siteDescription" type="textarea" placeholder="请输入网站描述" />
        </el-form-item>
        <el-form-item label="网站Logo" prop="siteLogo">
          ...
          >
            <img v-if="settingsForm.siteLogo" :src="settingsForm.siteLogo" class="avatar" />
        ...
        <el-form-item label="系统语言" prop="language">
          <el-select v-model="settingsForm.language" placeholder="请选择系统语言">
        ...
        <el-form-item label="邮件服务器" prop="emailServer">
          <el-input v-model="settingsForm.emailServer" placeholder="请输入邮件服务器地址" />
        </el-form-item>
        <el-form-item label="邮件端口" prop="emailPort">
          <el-input v-model.number="settingsForm.emailPort" type="number" placeholder="请输入邮件端口" />
        </el-form-item>
