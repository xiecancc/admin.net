  ...
  <div class="users-container">
    ...
    <el-card shadow="hover" class="users-card">
      ...
      <div class="users-filter">
        ...
        />
        <el-select v-model="statusFilter" placeholder="用户状态" style="width: 150px">
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="600px" @close="handleDialogClose">
      <el-form ref="userFormRef" :model="userForm" :rules="userRules" label-width="100px">
        ...
        <el-form-item label="头像 URL" prop="avatarUrl">
          <el-input v-model="userForm.avatarUrl" placeholder="请输入头像 URL" />
        </el-form-item>
...
import type { UserListDTO, UserCreateDTO, UserUpdateDTO } from "@/api/nswags/auto";
