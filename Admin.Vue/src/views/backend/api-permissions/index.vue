<template>
  <div class="api-permissions-container">
    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card shadow="hover" class="api-permissions-card">
          <template #header>
          ...
          <el-table
            ...
            style="width: 100%"
          >
            <el-table-column prop="name" label="API 名称" width="250" />
            <el-table-column prop="code" label="权限编码" width="250" />
            <el-table-column prop="path" label="API 路径" width="200">
              <template #default="{ row }">
                <el-tag size="small" type="info">{{ (row as any).method || "GET" }}</el-tag>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="700px" @close="handleDialogClose">
      <el-form ref="permissionFormRef" :model="permissionForm" :rules="permissionRules" label-width="120px">
        <el-form-item label="API 名称" prop="name">
          <el-input v-model="permissionForm.name" placeholder="请输入 API 名称（如：获取用户列表）" />
        </el-form-item>
        ...
        <el-form-item label="HTTP 方法" prop="method">
          <el-select v-model="permissionForm.method" placeholder="请选择 HTTP 方法" style="width: 100%">
        ...
        <el-form-item label="API 路径" prop="path">
          <el-input v-model="permissionForm.path" placeholder="请输入 API 路径（如：/api/users）" />
        </el-form-item>
